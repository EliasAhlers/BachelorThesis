...
config = {
    ...
    "model_config": {
        ...
        "finetuned_model":"llama-3-8b-Instruct-cefr-tuned-transform-v2", 
        "max_seq_length": 8192, 
        #"dtype":torch.float16, 
        "dtype":torch.float16,
    ...
    "training_dataset":{
        "name":"EliasAhl/german-cefr-transformed-decontaminated", # The dataset name(huggingface/datasets)
    ...
    "training_config": {
        ...
        "num_train_epochs": 8, # The number of training epochs(0 if the maximum steps are defined)
